...
using System.Windows.Forms; //System以降波線　2023/2/6 17:15
...
namespace clickBuster_cs
{
    internal class CEnemy
    {
        ...
        public CEnemy(Control owner, Random rand) 
        {
            ...
            //敵画像がクリックされたイベント
            _pbImgEnemy.Click += new EventHandler(DoClick); //DoClickに波線2023/2/6 17:15(解除17:26)
            //ランダムな場所に出現
            _RandPlace();   //_RandPlaceに波線2023/2/6 17:15 2023/2/6 17:45解除
            //オーナーに画像を張り付け
            _enemyOwner.Controls.Add(_pbImgEnemy);


        }
        //場所はここでいいのか？↓敵の画像からクリックイベントまで
        ...
        private void _RandPlace()
        {
            ...
            _intMovePattern = _rnd.Next(1, 4); //1と4の意味とは？　１から４までから１つ選ぶ？
        ...
        ///<summary>
        ///動かす(オーナーの中で動き) ※なぜか動かない20230208 20:27
        /// </summary>
        public void MvEnm()//
        {
            switch (_intMovePattern)
